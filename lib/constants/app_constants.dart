...
const String kKeyforgetEmail = "forget_email";
const String kKeyforgetOtp = "forget_otp";
...
const String kKeyRememberMe = 'remember_me';
...
const String kKeyIsFirstTime = "firstTime";
//order statuses
