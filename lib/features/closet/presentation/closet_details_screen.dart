...
class _ClosetDetailsScreenState extends State<ClosetDetailsScreen> {
    ...
    try {
      ...
      if (success) {
        getSingleClosetRxObj.getSingleClosetData.listen((closet) {
          setState(() {
            singleCloset = closet;
            selectedMaterials = closet.data?.material?.id?.toString();
            selectedSize = closet.data?.size ?? "";
            isLoading = false;
          });
        });
      } else {
  ...
  Future<void> postUpdateCloset(PostUpdateClosetModel closet, int closetId) async {
    setState(() {
      isUpdating = true;
    });
    try {
  ...
  Future<void> deleteCloset(int closetId) async {
    setState(() {
      isDeleting = true;
    });
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: isDeleting
            ? Lottie.asset(AppLotties.delete)
                    ...
                    : Padding(
                        ...
                        child: Column(
                          children: [
                                                ...
                                                PopupMenuItem<String>(
                                                    ...
                                                    child: Text(
                                                      ...
                                                      style: TextFontStyle.inter10W500.copyWith(
                                                          color: Color(0xFF5E5E5E), fontSize: 14.sp),
                                                    )),
                                                PopupMenuItem<String>(
                                                    value: 'market',
                                                    child: Text(
                                                          ...
                                                          _liatOfCategories.isEmpty
                                                              ...
                                                              : SizedBox(
                                                                  ...
                                                                  child: ListView.builder(
                                                                    itemCount:
                                                                        _liatOfCategories.first.data?.length ?? 0,
                                                                    itemBuilder: (context, index) {
                                                                      final category =
                                                                          _liatOfCategories.first.data?[index];
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(
                                              color: _occationContriller.text.isEmpty &&
                                                      singleCloset?.data?.occasion == null
                                                  ? Color(0xFFF0F0F0)
                                                  : AppColor.cD5E7B0,
                                              borderRadius: BorderRadius.circular(30.r),
                                            ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                                                ...
                                                                onTap: () {
                                                                  setModalState(() {
                                                                    if (_colorController.text.isNotEmpty &&
                                                                      ...
                                                                      final alreadyExists = _colorList.any((item) =>
                                                                          item == _colorController.text.trim());
                                          ...
                                          child: Container(
                                            width:
                                                _colorList.isEmpty && singleCloset?.data?.color == null ? 150.w : 220.w,
                                            padding: EdgeInsets.symmetric(
                                              horizontal: 12.w,
                                              vertical: 5.h,
                                            ),
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            SizedBox(
                                                              width: 168.w,
                                                              child: Text(
                                                                singleCloset!.data!.color!.take(5).join(", "),
                                                                style: TextFontStyle.textStyle12w400NunitoSans.copyWith(
                                                                  fontSize: 16.sp,
                                                                  color: AppColor.c000000,
                                                                  fontWeight: FontWeight.w400,
                                              ...
                                              child: DropdownButtonHideUnderline(
                                                  child: DropdownButton<String>(
                                                      ...
                                                      value: selectedMaterials ??
                                                          singleCloset?.data?.material?.id?.toString(),
                                                      hint: Text(
                                                        'Select Material',
                                                      ...
                                                      items: (_materialList.isNotEmpty &&
                                                              _materialList.first.data!.isNotEmpty)
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color:
                                                  _patternController.text.isEmpty && singleCloset?.data?.pattern == null
                                                      ? Color(0xFFF0F0F0)
                                                      : AppColor.cD5E7B0,
                                              borderRadius: BorderRadius.circular(30.r),
                                            ),
                                        ...
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child: Text(
                                                purchasedDate == null
                                                    ? singleCloset?.data?.purchasedDate != null
                                                        ? DateFormat("dd MMM yyyy").format(DateFormat("dd/MM/yy")
                                                            .parse(singleCloset!.data!.purchasedDate!))
                                                        : 'Select date'
                                          ...
                                          child: Container(
                                            ...
                                            child: Text(
                                              _priceController.text.isEmpty
                                                  ? singleCloset?.data?.price == null
                                                      ? 'Add'
                                                      : '\$${singleCloset?.data?.price}'
                            ...
                            UIHelper.verticalSpaceMedium,
                            CustomButton(
                                name: isUpdating ? 'Updating.....' : 'Update Closet',
                                onCallBack: () async {
                                  postUpdateCloset(
                                      PostUpdateClosetModel(
                                          title: _titleController.text.isNotEmpty
                                              ? _titleController.text.trim()
                                              : singleCloset?.data?.title ?? '',
                                          categories: _selectedCategories.isNotEmpty
                                              ? _selectedCategories
                                              : singleCloset?.data?.categories ?? [],
                                          occation: _occationContriller.text.isNotEmpty
                                              ? _occationContriller.text.trim()
                                              : singleCloset?.data?.occasion ?? '',
                                          brand: _brandController.text.isNotEmpty
                                              ? _brandController.text.trim()
                                              : singleCloset?.data?.brand ?? '',
                                          colors: _colorList.isNotEmpty ? _colorList : singleCloset?.data?.color ?? [],
                                          materialId: int.tryParse(selectedMaterials ?? "") ?? 0,
                                          pattern: _patternController.text.isNotEmpty
                                              ? _patternController.text.trim()
                                              : singleCloset?.data?.pattern ?? '',
                                          visibility: selectedVisibility,
                                          purchasedDate: purchasedDate ??
                                              DateFormat("dd/MM/yy").parse(singleCloset?.data?.purchasedDate ?? ''),
                                          size: selectedSize,
                                          price: _priceController.text.isNotEmpty
                                              ? _priceController.text.trim()
                                              : singleCloset?.data?.price ?? '',
                                          season: selectedSeason,
                                          image: singleCloset!.data!.image),
                                      widget.closetId);
                                },
                                color: AppColor.cD5E7B0,
